            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%=path%>/user-add" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                            ...
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="user" items="${reqAttributeUserList}" varStatus="status">
                                        	
	                                        <tr>
	                                            <td>${status.index+1}</td>
	                                            <td>${reqAttributeFirstNameList.get(status.index)}</td>
	                                            <td>${reqAttributeLastNameList.get(status.index)}</td>
	                                            <td>${user.getEmail()}</td>
