                                    ...
                                    <tbody>
                                   	 ...
                                   	 <c:forEach var="task" items="${reqAttributeTaskList}" varStatus="status">
	                                   	 <tr>
	                                            ...
	                                            <td>
	                                                <a href="<%= path%>/task-update?name=${task.getName()}&startdate=${task.getStringStartDate()}&enddate=${task.getStringEndDate()}&userid=${task.getIdUser()}&jobid=${task.getIdJob()}&statusid=${task.getIdStatus()}&id=${task.getId()}" class="btn btn-sm btn-primary">Sửa</a>
	                                                <a href="<%= path%>/task-delete?id=${task.getId()}" class="btn btn-sm btn-danger">Xóa</a>
