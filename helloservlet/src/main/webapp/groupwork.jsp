            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="<%= path%>/groupwork-add" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <c:forEach var="job" items="${reqAttributeJobList}" varStatus="status">

                                     	<tr>
                                            <td>${status.index+1 }</td>
                                            <td>${job.getName()}</td>
                                            <td>${job.getStringStartDate()}</td>
                                            <td>${job.getStringEndDate()}</td>
                                            <td>
